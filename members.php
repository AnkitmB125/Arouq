		...
		<div class="container">
			...
			<div class="content">
				...
				<div id="user_timeline">
					<div id="user_details">
						...
						echo "
							...
							<p><a href='my_messages.php'>My Messages($count_msg)</a></p>
				...
				<div id="content_timeline">
					...
					<h2>All Registered Users on the site!</h2>
					<?php 
						...
						{						
							...
							$user_name = $row['user_name'];
							$user_image = $row['user_image'];
						echo "<a href='user_profile.php?u_id=$user_id'><img src='user/user_images/$user_image' width='80px' height='80px' title='$user_name' /></a>";
					}
					?>
				</div>
